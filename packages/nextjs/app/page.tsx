...
// const [selectedNetwork, setSelectedNetwork] = React.useState("goerli");
      ...
      <div className="flex items-center flex-col flex-grow pt-10">
        <div className="px-5">
          <h1 className="text-center">
            <span className="block text-4xl mt-32 font-bold">Tiny DEX</span>
          </h1>
          <p className="py-8 text-center">No Chickfill-a Sauce !!</p>
        </div>
